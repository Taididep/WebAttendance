...
// Tạo URL cho class_detail.php với class_id và schedule_id
$detailUrl = 'http://' . $_SERVER['HTTP_HOST'] . '/Student/Attendance/attendance_view.php?class_id=' . urlencode($class_id) . '&schedule_id=' . urlencode($schedule_id); // Cập nhật đường dẫn đúng
...
<head>
    ...
    <style>
        ...
        @media (max-width: 576px) {
            h2 {
                font-size: 1.5rem;
                /* Thay đổi kích thước tiêu đề trên màn hình nhỏ */
            }

            #qrCode {
                width: 80%;
                /* Kích thước mã QR trên màn hình nhỏ */
                height: auto;
            }
        }
    </style>
