...
if ($class_id) {
    ...
    SELECT 
        ...
        s.class
    FROM students s
    WHERE s.class = (SELECT class FROM classes WHERE class_id = :class_id)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_student_id'])) {
    ...
    echo '<div class="alert alert-success mt-3" role="alert">Xóa sinh viên thành công!</div>';
...
<body>
    <div class="container mt-4">
        ...
        <button onclick="window.location.href='teacher.php'" class="btn btn-secondary">Quay lại trang</button>
